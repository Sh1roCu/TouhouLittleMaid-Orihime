...
public class MaidWrappedPathFinder extends PathFinder {
    ...
    @Nullable
    @Override
    public Path findPath(@NotNull ProfilerFiller profiler, @NotNull Node node, @NotNull Map<Target, BlockPos> targetPos, float maxRange, int accuracy, float searchDepthMultiplier) {
