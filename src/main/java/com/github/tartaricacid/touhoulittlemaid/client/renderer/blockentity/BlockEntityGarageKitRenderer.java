...
public class BlockEntityGarageKitRenderer implements BlockEntityRenderer<BlockEntityGarageKit, GarageKitRenderState> {
    ...
    public BlockEntityGarageKitRenderer(BlockEntityRendererProvider.Context context) {
