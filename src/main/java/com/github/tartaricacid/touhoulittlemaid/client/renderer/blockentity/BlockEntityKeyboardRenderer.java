...
public class BlockEntityKeyboardRenderer extends BlockEntityJoyRenderer<BlockEntityKeyboard> {
    ...
    public BlockEntityKeyboardRenderer(BlockEntityRendererProvider.Context context) {
