...
public class BlockEntityWChessRenderer implements BlockEntityRenderer<BlockEntityWChess, WChessRenderState> {
    ...
    public BlockEntityWChessRenderer(BlockEntityRendererProvider.Context context) {
