...
import static com.github.tartaricacid.touhoulittlemaid.client.resource.bedrock.InternalBedrockModelRegistry.MARISA_YUKKURI;
...
public class EntityMarisaYukkuriSlimeRender extends MobRenderer<MagmaCube, SlimeRenderState, EntityModel<SlimeRenderState>> {
    ...
    public EntityMarisaYukkuriSlimeRender(EntityRendererProvider.Context context) {
        super(context, InternalBedrockModelRegistry.getEntityModel(MARISA_YUKKURI), 0.25F);
