...
public class CompassRenderEvent {
    ...
    public static void onRender(LevelRenderContext context) {
        ...
        if (workPos != null) {
            ...
            RenderHelper.renderCylinder(context.poseStack(), buffer, centerPos, radius, 16, 1.0F, 0, 0);
            ...
            RenderHelper.renderFloatingText(context.poseStack(), text, textPos.x, textPos.y, textPos.z, 0xff1111, 0.15f, true, -5, false);
            RenderHelper.renderFloatingText(context.poseStack(), "▼", textPos.x, textPos.y, textPos.z, 0xff1111, 0.15f, true, 5, false);
        }
        ...
        if (idlePos != null) {
            ...
            VertexConsumer buffer = mc.renderBuffers().bufferSource().getBuffer(RenderTypes.LINES);
            RenderHelper.renderCylinder(context.poseStack(), buffer, centerPos, radius, 16, 0, 1.0F, 0);
            ...
            if (idlePos.equals(workPos)) {
                ...
                RenderHelper.renderLine(context.poseStack(), buffer, centerPos, prePos, 1.0f, 1.0f, 1.0f);
            }
            String text = I18n.get("message.touhou_little_maid.kappa_compass.idle_area");
            RenderHelper.renderFloatingText(context.poseStack(), text, textPos.x, textPos.y, textPos.z, 0x11ff11, 0.15f, true, -5, false);
            RenderHelper.renderFloatingText(context.poseStack(), "▼", textPos.x, textPos.y, textPos.z, 0x11ff11, 0.15f, true, 5, false);
        }
        ...
        if (resetPos != null) {
            ...
            VertexConsumer buffer = mc.renderBuffers().bufferSource().getBuffer(RenderTypes.LINES);
            RenderHelper.renderCylinder(context.poseStack(), buffer, centerPos, radius, 16, 0, 0, 1.0F);
            ...
            RenderHelper.renderFloatingText(context.poseStack(), text, textPos.x, textPos.y, textPos.z, 0x1111ff, 0.15f, true, -5, false);
            RenderHelper.renderFloatingText(context.poseStack(), "▼", textPos.x, textPos.y, textPos.z, 0x1111ff, 0.15f, true, 5, false);
        }
